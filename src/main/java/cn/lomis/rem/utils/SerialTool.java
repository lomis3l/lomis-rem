...
import cn.lomis.rem.exception.SendDataToSerialPortFailure;
import cn.lomis.rem.exception.SerialPortInputStreamCloseFailure;
import cn.lomis.rem.exception.SerialPortOutputStreamCloseFailure;
...
public class SerialTool {
     ...
     */
    public static void addListener(SerialPort port, SerialListener listener) throws TooManyListeners {
        try {
			// 给串口添加监听器
